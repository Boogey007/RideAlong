...
public class NotificationHelper extends ContextWrapper {
    ...
    private void createChannel() {
        // reference https://developer.android.com/reference/android/app/NotificationChannel
...
// refer to this https://stackoverflow.com/questions/61696587/location-tracker-by-using-firebase for request notification
    @RequiresApi(api = Build.VERSION_CODES.O)
